...
""",
    ...
    "data": [
        ...
        "views/rental_shortage_views.xml",
        "views/rental_pricing_views.xml",
        "views/rental_document_views.xml",
    ...
    "assets": {
        "web.assets_backend": [
            ...
            "aq_rental_serial_planning/static/src/reports/commercial_reports.scss",
            "aq_rental_serial_planning/static/src/reports/commercial_reports.xml",
            "aq_rental_serial_planning/static/src/reports/commercial_reports.js",
        ],
    },
    "application": True,
    "installable": True,
